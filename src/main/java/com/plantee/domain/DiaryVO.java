...
public class DiaryVO extends StoreVO{
	...
	public String toString() {
		return "DiaryVO [diary_id=" + diary_id + ", user_id=" + user_id + ", plant_id=" + plant_id + ", plant_name="
				+ plant_name + ", image=" + image + ", contents=" + contents + ", reg_date=" + reg_date
				+ ", last_watering=" + last_watering + ", icon_sun=" + icon_sun + ", icon_water=" + icon_water
				+ ", category=" + category + ", watering=" + watering + ", sunlight=" + sunlight + ", fmtdate="
				+ fmtdate + ", waterdate=" + waterdate + ", date_now=" + date_now + ", date_water=" + date_water
				+ ", date_medicine=" + date_medicine + ", date_change=" + date_change + ", uid=" + uid
